...
import { MatListModule, MatIconModule, MatButtonModule, MatDialogModule,
   MatFormFieldModule, MatInputModule, MatTableModule, MatSelectModule, MatMenuModule, MatToolbarModule, MatChipsModule, MatProgressSpinnerModule } from '@angular/material';
...
@NgModule({
  ...
  declarations: [HomeComponent, NavigationComponent, StudentsListComponent, EventsComponent,
     ChatsComponent, AddEventComponent, AddChatComponent, SingleChatComponent,
     ProfileComponent, EventDetailsComponent, EventsEntriesComponent],
